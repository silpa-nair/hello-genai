...
- When creating skills, generate scripts that retrieve data from the file system and write it to other files during execution. This preserves tokens and minimizes hallucinations — the model should focus less on monitoring the data and rely more on the deterministic script developed within the skill.
...
Copied from [codenjoyme/vibecoding-training](https://github.com/codenjoyme/vibecoding-training/blob/main/instructions/creating-instructions.agent.md).
